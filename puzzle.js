...
//create array of puzzle images from online
var images = [
...
function setPieceColor() {
    puzzlePiece.forEach(piece => {
        ...
        pickedColors.push(randomNum); //this will be used to avoid picking the same color twice
        ...
        var imgPath = "./images/puzzle1/" + images[randomNum];
...
puzzleImage.style.background = "url(./images/puzzle1/puzzle1.jpeg)";
...
puzzlePiece.forEach(piece => {
    piece.addEventListener('click', (e) => {
        ...
        if (id1S == false) {
            ...
            document.getElementById(id2).style.transform = "scale(1.15)";
